...
execute at @e[team=RedData,scores={FlagPresent=1}] run scoreboard players set @p[distance=..3,scores={CarryingRedFlag=0},team=!Red] StealsFlag 1
execute if entity @p[scores={StealsFlag=1},team=!Red] run function geo1088.ctf:events/steal/red
execute at @e[team=BlueData,scores={FlagPresent=1}] run scoreboard players set @p[distance=..3,scores={CarryingBlueFlag=0},team=!Blue] StealsFlag 1
execute if entity @p[scores={StealsFlag=1},team=!Blue] run function geo1088.ctf:events/steal/blue
...
execute if entity @p[scores={CapturesFlag=1},team=!Red] run function geo1088.ctf:events/capture/red
execute at @e[team=BlueData] run scoreboard players set @p[distance=..3,scores={CarryingRedFlag=1},team=Blue] CapturesFlag 1
execute if entity @p[scores={CapturesFlag=1},team=!Blue] run function geo1088.ctf:events/capture/blue
