...
# Text
tellraw @a[team=Red] [{"color": "gold", "text": "> "}, {"selector": "@p[scores={StealsFlag=1},team=Blue]", "color": "blue"}, {"color": "reset", "text": " has "}, {"text": "stolen your flag!", "color": "gold"}]
tellraw @a[team=Blue] [{"color": "green", "text": "> "}, {"selector": "@p[scores={StealsFlag=1},team=Blue]", "color": "blue"}, {"color": "reset", "text": " has "}, {"text": "stolen the enemy flag!", "color": "green"}]
