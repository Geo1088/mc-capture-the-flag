...
tellraw @a [{"selector": "@p[scores={CapturesFlag=1}]", "color": "yellow"}, " has died. Your flag has been ", {"text": "returned.", "color": "green"}]
tellraw @a [{"text": "The flag has been returned.", "color": "gold"}]
tellraw @a [{"selector": "@p[scores={CapturesFlag=1}]", "color": "yellow"}, " has died. The enemy flag has been ", {"text": "returned.", "color": "gold"}]
