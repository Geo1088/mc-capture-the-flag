...
scoreboard players set @p[scores={CarryingBlueFlag=1,Health=0},team=!Blue] CarryingBlueFlag 0
...
# tellraw @a[team=!Blue,scores={CapturesFlag=1}] [{"text": "The flag has been returned.", "color": "gold"}]
# tellraw @a[team=!Blue,scores={CapturesFlag=0}] [{"selector": "@p[scores={CapturesFlag=1}]", "color": "yellow"}, " has died. The enemy flag has been ", {"text": "returned.", "color": "gold"}]
